...
class RawframeDataset(BaseActionDataset):
    ...
    def __init__(self,
                 ...
                 # filename_tmpl: str = '{:08}.png',#hardvs
                 filename_tmpl: str = '{:04}.png',#poker
    ...
    def load_data_list(self) -> List[dict]:
        ...
        for line in fin:
            ...
            if self.data_prefix['img'] is not None:
                ###########################################################################################
                # frame_dir = str(frame_dir)+str(frame_dir[10:])+'_dvs'
                # frame_dir = str(frame_dir)+str(frame_dir[10:])+'_aps'
                #################################################################################################
